({
    ...
    // Get Lead Name
    getLeadName: function(component, event, helper, topicName, currentRecordId) {
        var action = component.get("c.getLeadName");
        action.setParams({
            name: topicName,
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {   
                ...
                var leadName = getValues[0].Name;
                this.showToast(
                    "Success !",
                    " "+topicName+" Tag is assigned to "+ leadName,
                    "success"
                );  
            } else {
    ...
    assignTopic: function(component, event, helper, currentRecordId, labelName, isModel){
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                this.getLeadName(component, event, helper, labelName, currentRecordId);                
    ...
    // Get Assigned Topic to Lead - On Page Load
