({
    ...
    // Get Contact Name
    getContactName: function(component, event, helper, topicName, currentRecordId) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {   
                ...
                var ContactName = getValues[0].Name;
                this.showToast(
                    "Success !",
                    " "+topicName+" Tag is assigned to "+ ContactName,
                    "success"
                );  
            } else {
    ...
    // Assign Topic to Contact - On Click
    assignTopic: function(component, event, helper, currentRecordId, labelName, isModel){
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                this.getContactName(component, event, helper, labelName, currentRecordId);                
    ...
    // Get Assigned Topic to Contact - On Page Load
